...
public interface GMSVListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GMSVParser#endif}.
	 * @param ctx the parse tree
	 */
	void enterEndif(GMSVParser.EndifContext ctx);
	/**
	 * Exit a parse tree produced by {@link GMSVParser#endif}.
	 * @param ctx the parse tree
	 */
	void exitEndif(GMSVParser.EndifContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GMSVParser#total}.
	 * @param ctx the parse tree
	 */
	void enterTotal(GMSVParser.TotalContext ctx);
	/**
	 * Exit a parse tree produced by {@link GMSVParser#total}.
	 * @param ctx the parse tree
	 */
	void exitTotal(GMSVParser.TotalContext ctx);
	/**
